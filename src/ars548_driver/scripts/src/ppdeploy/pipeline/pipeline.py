...
from pptracking.python.mot.utils import flow_statistic, flow_statistic_multi_class, update_object_info
...
class PipePredictor(object):
    ...
    def visualize_video(self,
        ...
        if mot_res is not None:
            ids = copy.deepcopy(mot_res['boxes'][:, 0])
            scores = copy.deepcopy(mot_res['boxes'][:, 2])
            boxes = copy.deepcopy(mot_res['boxes'][:, 3:])
